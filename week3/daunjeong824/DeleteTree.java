...
public class DeleteTree {
    ...
    public static KillerPos treeKiller(int st_x, int st_y) {
        ...
        //System.out.println("killer position : " + st_x + " : " + st_y);
        for(int i = 0; i < 4; i++) {
            ...
            for(int tmp = 0; tmp < K; tmp++) {
                if(inRange(x, y)) {
                    ...
                    //System.out.println("dir : " + i + " nx : " + x + " ny : " + y);
                }
            }
        }
...
//        System.out.println("제초제 집합 출력 : ");
//        StringBuilder sb2 = new StringBuilder();
//        for(KillerPos p : killerSet)
//            sb2.append(p.st_x).append(" : ").append(p.st_y).append(", 나무 죽인 양 : ").append(p.killTree).append(" ");
...
//        System.out.println();
    ...
    public static void debug(int c) {
        StringBuilder sb = new StringBuilder();

        if(c==1) {
            System.out.println("나무 맵");
                for(int i = 0; i < N; i++) {
                    for(int j = 0; j < N; j++){
            ...
            System.out.println("제초제 맵");
            for(int i = 0; i < N; i++) {
                for(int j = 0; j < N; j++){
                    sb.append(treeKillerMaps[i][j]).append(" ");
                }
                sb.append("\n");
            }
        }
