...
public class PriorityQueue {
    ...
    /*
     * Comparator를 통해 우선순위를 직접 설정할 수 있는 우선순위 큐 구현
     */
    ...
    /*
     * 절댓값이 작은 값(절댓값이 같은 경우 작은 값)이 top에 있는 우선순위 큐 테스트
     */
